...
before starting executable/MCP process behavior, whose nextest concurrency uses
three workers on macOS and four on Linux or Windows, and then runs the fixture
aggregate serially. Any
